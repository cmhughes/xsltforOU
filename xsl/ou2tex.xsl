...
<xsl:template match="exerciseORIG">
...
<xsl:template match="exercises">
  <xsl:text>\begin{exercises}</xsl:text>
  <xsl:apply-templates/>
...
<!-- subExercise environments -->
<xsl:template match="subexercise">
	<xsl:text>\subexercise</xsl:text>
	<xsl:apply-templates/>
</xsl:template>
